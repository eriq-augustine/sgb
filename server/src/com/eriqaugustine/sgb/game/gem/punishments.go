...
var patterns = []DropPattern{
   ...
   // Chun-Li
   DropPattern{[][]int{
      []int{COLOR_RED,      COLOR_RED,    COLOR_GREEN,  COLOR_GREEN,  COLOR_BLUE,   COLOR_BLUE},
      []int{COLOR_RED,      COLOR_RED,    COLOR_GREEN,  COLOR_GREEN,  COLOR_BLUE,   COLOR_BLUE},
      []int{COLOR_YELLOW,   COLOR_YELLOW, COLOR_RED,    COLOR_RED,    COLOR_GREEN,  COLOR_GREEN},
      []int{COLOR_YELLOW,   COLOR_YELLOW, COLOR_RED,    COLOR_RED,    COLOR_GREEN,  COLOR_GREEN},
   }},

   // Sakura
   DropPattern{[][]int{
      []int{COLOR_GREEN, COLOR_RED,    COLOR_RED,    COLOR_RED,    COLOR_RED,    COLOR_YELLOW},
      []int{COLOR_GREEN, COLOR_BLUE,   COLOR_BLUE,   COLOR_BLUE,   COLOR_BLUE,   COLOR_YELLOW},
      []int{COLOR_GREEN, COLOR_RED,    COLOR_RED,    COLOR_RED,    COLOR_RED,    COLOR_YELLOW},
      []int{COLOR_GREEN, COLOR_BLUE,   COLOR_BLUE,   COLOR_BLUE,   COLOR_BLUE,   COLOR_YELLOW},
   }},
   ...
   // Morrigan
   DropPattern{[][]int{
      []int{COLOR_BLUE,     COLOR_YELLOW, COLOR_RED,    COLOR_RED,    COLOR_YELLOW, COLOR_BLUE},
      []int{COLOR_BLUE,     COLOR_YELLOW, COLOR_RED,    COLOR_RED,    COLOR_YELLOW, COLOR_BLUE},
      []int{COLOR_YELLOW,   COLOR_BLUE,   COLOR_GREEN,  COLOR_GREEN,  COLOR_BLUE,   COLOR_YELLOW},
      []int{COLOR_YELLOW,   COLOR_BLUE,   COLOR_GREEN,  COLOR_GREEN,  COLOR_BLUE,   COLOR_YELLOW},
   }},
   ...
   // Donovan
   DropPattern{[][]int{
      []int{COLOR_RED,   COLOR_YELLOW, COLOR_RED,    COLOR_YELLOW, COLOR_RED,    COLOR_YELLOW},
      []int{COLOR_RED,   COLOR_YELLOW, COLOR_RED,    COLOR_YELLOW, COLOR_RED,    COLOR_YELLOW},
      []int{COLOR_GREEN, COLOR_GREEN,  COLOR_GREEN,  COLOR_BLUE,   COLOR_BLUE,   COLOR_BLUE},
      []int{COLOR_GREEN, COLOR_GREEN,  COLOR_GREEN,  COLOR_BLUE,   COLOR_BLUE,   COLOR_BLUE},
   }},

   // Felicia
   DropPattern{[][]int{
      []int{COLOR_GREEN, COLOR_RED,    COLOR_RED,    COLOR_BLUE,   COLOR_BLUE,   COLOR_YELLOW},
      []int{COLOR_GREEN, COLOR_RED,    COLOR_RED,    COLOR_BLUE,   COLOR_BLUE,   COLOR_YELLOW},
      []int{COLOR_GREEN, COLOR_BLUE,   COLOR_BLUE,   COLOR_RED,    COLOR_RED,    COLOR_YELLOW},
      []int{COLOR_GREEN, COLOR_BLUE,   COLOR_BLUE,   COLOR_RED,    COLOR_RED,    COLOR_YELLOW},
   }},
};
